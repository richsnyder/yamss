...
FUNCTION(CONFIGURATION_REPORT)
  ...
  VERSION_OR_NOT_FOUND(VAR convert_version PACKAGE ImageMagick VERSION ImageMagick_VERSION_STRING)
  VERSION_OR_NOT_FOUND(VAR pandoc_version PACKAGE Pandoc)
  YES_OR_NO(latex_indicator PDFLATEX_COMPILER)
  YES_OR_NO(doc_indicator BUILD_DOC)
  YES_OR_NO(html_indicator ENABLE_HTML)
  YES_OR_NO(pdf_indicator ENABLE_PDF)
